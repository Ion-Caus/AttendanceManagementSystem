...
public class ClassesDAOImpl implements ClassesDAO
{
  ...
  @Override public void addClass(Class aClass) throws SQLException
  {
  ...
  @Override public ArrayList<Class> readClasses() throws SQLException
  {
    try (Connection connection = getConnection())
    {
      PreparedStatement statement = connection
  ...
  @Override public void removeClass(String className) throws SQLException
  {
    try (Connection connection = getConnection())
    {
      PreparedStatement statement = connection
